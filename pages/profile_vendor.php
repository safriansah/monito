<div id="page-wrapper">
    ...
    <tbody>
     <?php
	   ...
	   <?php echo"<a class='btn btn-info btn-sm' href='?pages=edit_profile_vendor&edit=true&id=$data[no]'><i class='glyphicon glyphicon-edit icon-white'></i></a>"?>
       <?php echo"<a class='btn btn-danger btn-sm' href='?pages=profile_vendor&hapus=true&id=$data[id]' onclick='return confirm(\"Apakah Anda yakin ?\")'>  <i class='glyphicon glyphicon-trash icon-white'></i></a>"?>
        </td>
    </tr>
            <?php $no++; } ?>
    </tbody>
