...
if(isset($_POST['ubah_foto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
  ...
  if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
    ...
    if($sql){ // Cek jika proses simpan ke database sukses atau tidak
      // Jika Sukses, Lakukan :
	   echo '<script language="javascript">alert("Data berhasil diubah");document.location="../index.php?pages=view_pengawas";</script>';
    }else{
      // Jika Gagal, Lakukan :
     echo '<script language="javascript">alert("Maaf, Terjadi kesalahan saat mencoba untuk menyimpan data");document.location="../index.php?pages=edit_pengawas";</script>';
    }
  }else{
    // Jika gambar gagal diupload, Lakukan :
	echo '<script language="javascript">alert("Maaf, gambar gagal diupload");document.location="../index.php?pages=edit_pengawas";</script>';
  }
