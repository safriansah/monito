...
header("content-disposition: attachment;filename=Data-pengawas-Tiang-Beton.xls");
?>
<?php
$tahun=  date("Y");
...
?>
<center><h3>LAPORAN DATA PENGAWAS </h3></center>
...
<td width=100 style="text-align:center;">Sesuai/Tidak Sesuai</td>
...
<tr>
	...
	<td align="center"  style='height:24px;'><?php echo $kesenian['s_t']; ?></td>
